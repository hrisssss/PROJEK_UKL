...
if (isset($_POST['update'])) {
        ...
        $sql = "INSERT INTO jadwal_konsultasi  (nama_pasien, keluhan, no_wa_pasien, tanggal_konsul, id_dokter, id_user) VALUES ('$nama_pasien', '$keluhan', '$no_wa_pasien', '$tanggal_konsul', '$id_dokter', '$id_user')";
...
<body>
    ...
    <p>Jadwal konsultasi Anda telah berhasil dibuat. Silakan periksa email Anda untuk detail lebih lanjut.</p>
    ...
    <footer>
        ...
        <a href="formulirjdwl.php">Cek formulir invoice</a>
        <a href="beranda.php">Kembali ke Beranda</a>
        <a href="index.php">Mulai Konsultasi</a>
</body>
</html>